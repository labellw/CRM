...
class UserInfo(models.Model):
    ...
    user = models.OneToOneField(User)      #一对一权限rbac中的User表
...
class Customer(models.Model):
    ...
    last_consult_date = models.DateField(verbose_name="最后跟进日期", )                   #客户和销售关系用的字段
...
class ClassStudyRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo', limit_choices_to={"depart_id__in": [1000, 1001]})
